...
public class CometdDemoServlet extends GenericServlet
{
    ...
    public static class Monitor extends BayeuxService
    {
        ...
        {
        	System.out.println("Subscribe from "+client+" for "+message.get(Bayeux.SUBSCRIPTION_FIELD));
        }

        public void monitorUnsubscribe(Client client, Message message)
        {
        	System.out.println("Unsubscribe from "+client+" for "+message.get(Bayeux.SUBSCRIPTION_FIELD));
        }
